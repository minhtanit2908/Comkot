package com.zasa.comkot.sharedpref
...
fun createComkotSharedPref(context: Context, prefName: String): ComkotSharedPref =
    ComkotSharedPrefIml(context.getSharedPreferences(prefName, 0))
